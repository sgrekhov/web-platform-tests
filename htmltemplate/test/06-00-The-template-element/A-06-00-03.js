...
test(function () {
    ...
    assert_equals(t.content.childNodes.length, 1, 'Wrong number of template content children');
    assert_equals(t.content.firstChild.nodeName, 'DIV', 'Template should contain ' +
...
test(function () {
    ...
    assert_equals(t.content.childNodes.length, 2, 'Wrong number of template content children');
    assert_true(t.content.querySelector('#dv1') != null, 'Template should contain children of ' +
    		'the ignored BODY element');
    assert_true(t.content.querySelector('#dv2') != null, 'Template should contain valid element');
...
test(function () {
    ...
    assert_equals(t.content.childNodes.length, 2, 'Template cannot contain BODY element');
    assert_true(t.content.querySelector('#dv1') != null, 'Template should contain valid element');
    assert_true(t.content.querySelector('#dv2') != null, 'Template should contain children of ' +
    		'the ignored BODY element');
...
test(function () {
    ...
    assert_equals(t2.content.childNodes.length, 1, 'Template cannot contain BODY element');
    assert_equals(t2.content.firstChild.nodeName, 'SPAN', 'Template cannot contain BODY element');
...
//innerHTML. Tesy empty BODY element
test(function () {
    var d = newHTMLDocument();
    var t = d.createElement('template');
